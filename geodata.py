...
datasink5 = glueContext.write_dynamic_frame.from_catalog(frame = resolvechoice5, database = "geo", table_name = "sub123_public_geo_dis", redshift_tmp_dir = args["TempDir"], transformation_ctx = "datasink5")
job.commit()